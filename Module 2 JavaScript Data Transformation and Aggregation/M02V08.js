...
//? Todo
//? 1. create an empty object to store the results
//? 2. loop over the sales array
//? 3. check if the category already exists in the object
//? 4. if it does, update the total revenue and item count
//? 5. if it doesn't, create an new object and add it to the object
//? 6. return the final grouped object

const totallRevnueWithQuantity = sales.reduce((acc, item) => {
...
console.log(totallRevnueWithQuantity);